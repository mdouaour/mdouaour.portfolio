  ...
  return (
    ...
    >
      ...
      <h1 className="text-5xl md:text-7xl font-extrabold text-white leading-tight mb-4">
        Mohammed Yassine
        <br />
        <span className="text-indigo-400">Douaouria</span>
      </h1>

      <p className="text-gray-400 text-lg md:text-xl max-w-2xl mb-8">
        Full-Stack Software Engineer · Python · React · AI Enthusiast
      ...
      <div className="flex flex-wrap justify-center gap-4">
        ...
        <a
          href="#contact"
          className="px-6 py-3 rounded-lg border border-gray-700 hover:border-indigo-500 text-gray-300 hover:text-white font-semibold transition-colors"
        >
          Contact Me
        </a>
      </div>
