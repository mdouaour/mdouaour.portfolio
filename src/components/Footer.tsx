            ...
            <ul className="space-y-2">
              {navLinks.map((key) => (
                <li key={key}>
                  <a
                    href={`#${key}`}
                    className="text-text-dim hover:text-text-accent transition-colors"
                  >
                    {Nav[key]}
                  </a>
                </li>
            ...
            <div className="flex flex-wrap justify-center sm:justify-start gap-2">
              {socialLinks.map((link) => (
                <a
                  ...
                  className="w-9 h-9 flex items-center justify-center rounded-xl bg-surface-elevated hover:bg-surface-hover text-text-dim hover:text-text-accent transition-all hover:-translate-y-0.5"
                >
