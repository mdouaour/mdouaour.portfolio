...
export const translations: TranslationSet = {
  ...
  ar: {
    ...
    about: {
      ...
      background: 'الخلفية',
      backgroundText1:
        'خريج علوم الحاسوب من جامعة قالمة ومشارك في برنامج ALX لهندسة البرمجيات. أقدم حلولاً متكاملة — من واجهات دقيقة إلى خوادم متمرسة.',
      backgroundText2:
      ...
      alx: 'ALX Software Engineering',
      alxSub: 'ALX Africa — برنامج تعلم نظيري تحويلي برعاية Holberton School',
